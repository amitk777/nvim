...
return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<F5>', function()
      dap.continue()
      vim.cmd.Neotree('close') -- this will toggle the Neo tree during debugging
    end)
    ...
    --vim.fn.sign_define('DapBreakpoint', { text = '🐞', texthl = 'blue', linehl = 'blue', numhl = 'green' })
    ...
    dap.configurations.python = {
      {
        ...
        program = "${file}",
        pythonPath = function()
          return '/home/amit/anaconda3/envs/nlp/bin/python3'
        end,
      },
    }
  end,
